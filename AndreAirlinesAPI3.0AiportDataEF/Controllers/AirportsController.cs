...
namespace AndreAirlinesAPI3._0AiportDataEF.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class AirportsController : ControllerBase
    {
        private readonly AndreAirlinesAPI3_0AirportDataEFContext _context;

        public AirportsController(AndreAirlinesAPI3_0AirportDataEFContext context)
        {
            _context = context;
        }
