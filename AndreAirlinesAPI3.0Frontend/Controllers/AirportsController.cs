...
namespace AndreAirlinesAPI3._0Frontend.Controllers
{
    ...
    {
        private readonly AndreAirlinesAPI3_0FrontendContext _context;

        public AirportsController(AndreAirlinesAPI3_0FrontendContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,City,Country,Code,Continent")] Airport airport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,City,Country,Code,Continent")] Airport airport)
        {
            if (id != airport.Id)
            {
                return NotFound();
